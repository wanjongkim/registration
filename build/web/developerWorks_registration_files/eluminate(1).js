...
function storeIBMStatsEvent(data,obj,linkIdentifier){
	var statsObjList = JSON.parse(JSON.stringify(obj));
...
function createUtagLinkObject(obj){
	...
	if(typeof utag !== "undefined"){
		...
		if(typeof window.ibm_global_data !== "undefined" && typeof ibm_global_data["Site ID"] != "undefined" && 
					(obj.ibmEV.toLowerCase().indexOf("rich_media_service") !== -1 || obj.ibmEV.toLowerCase().indexOf("video player") !== -1)){
		...
		if(!obj.ibmConversion && !obj.ibmProductTag) {
			if(typeof obj.ibmEvAction !== "undefined" && obj.ibmEvAction.length > 50){
	...
	storeTealiumPageviewData : function(){
		if (typeof (window.utag) != "undefined") {
			...
			for(var i=0;i<x.length;i++){
				...
				if(firstPart.indexOf('PageviewTag_pv_a') !== -1) {
					var k = firstPart.substring(17,firstPart.length-1);
					arr[k] = lastPart;
				}
			}
